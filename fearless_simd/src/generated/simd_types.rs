...
impl<S: Simd> crate::SimdFloat<f32, S> for f32x4<S> {
    ...
    #[inline(always)]
    fn madd(self, a: impl SimdInto<Self, S>, b: impl SimdInto<Self, S>) -> f32x4<S> {
        self.simd.madd_f32x4(self, a.simd_into(self.simd), b.simd_into(self.simd))
    }
    #[inline(always)]
...
impl<S: Simd> crate::SimdFloat<f32, S> for f32x8<S> {
    ...
    #[inline(always)]
    fn madd(self, a: impl SimdInto<Self, S>, b: impl SimdInto<Self, S>) -> f32x8<S> {
        self.simd.madd_f32x8(self, a.simd_into(self.simd), b.simd_into(self.simd))
    }
    #[inline(always)]
